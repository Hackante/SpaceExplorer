...
module.exports = async (interaction, client) => {
    ...
    if (interaction.customId.startsWith("dev")) {
        switch (interaction.customId) {
            ...
            case "dev-changes": {
                let embed = {
                    ...
                    title: "Change Log",
                    description: find("changes-message"),
                    author: {
                ...
                let components = [
                    {
                        ...
                        components: [
                            {
                                type: 2,
                                custom_id: "changes-confirm",
                                label: "Confirm",
                                style: 3,
                                disabled: false,
                            }, {
                                type: 2,
                                custom_id: "changes-cancel",
                                label: "Cancel",
                                style: 4,
                                disabled: false,
                            }, {
                                type: 2,
                                custom_id: "changes-all",
                                label: "All",
                                style: 1,
                                disabled: false,
                            }
                ...
                let res = await client.db.set("dev-changes-pre", embed);
                let repl = await interaction.reply({ content: "Change log updated!", embeds: [res], components, fetchReply: true });
                setTimeout(() => {
